...
namespace CreateUpdate.ProductServiceRef {
    ...
    public interface IProduct {
        ...
        CreateUpdate.ProductServiceRef.Product GetProduct(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProduct/GetProduct", ReplyAction="http://tempuri.org/IProduct/GetProductResponse")]
        System.Threading.Tasks.Task<CreateUpdate.ProductServiceRef.Product> GetProductAsync(int id);
        ...
        CreateUpdate.ProductServiceRef.UpdateProductResponse UpdateProduct(CreateUpdate.ProductServiceRef.UpdateProductRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProduct/UpdateProduct", ReplyAction="http://tempuri.org/IProduct/UpdateProductResponse")]
        System.Threading.Tasks.Task<CreateUpdate.ProductServiceRef.UpdateProductResponse> UpdateProductAsync(CreateUpdate.ProductServiceRef.UpdateProductRequest request);
    }
    ...
    public partial class UpdateProductRequest {
        ...
        public CreateUpdate.ProductServiceRef.Product product;
        ...
        public UpdateProductRequest(CreateUpdate.ProductServiceRef.Product product, string message) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IProductChannel : CreateUpdate.ProductServiceRef.IProduct, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ProductClient : System.ServiceModel.ClientBase<CreateUpdate.ProductServiceRef.IProduct>, CreateUpdate.ProductServiceRef.IProduct {
        ...
        public CreateUpdate.ProductServiceRef.Product GetProduct(int id) {
            return base.Channel.GetProduct(id);
        }
        
        public System.Threading.Tasks.Task<CreateUpdate.ProductServiceRef.Product> GetProductAsync(int id) {
            return base.Channel.GetProductAsync(id);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CreateUpdate.ProductServiceRef.UpdateProductResponse CreateUpdate.ProductServiceRef.IProduct.UpdateProduct(CreateUpdate.ProductServiceRef.UpdateProductRequest request) {
            return base.Channel.UpdateProduct(request);
        }
        
        public bool UpdateProduct(CreateUpdate.ProductServiceRef.Product product, ref string message) {
            CreateUpdate.ProductServiceRef.UpdateProductRequest inValue = new CreateUpdate.ProductServiceRef.UpdateProductRequest();
            inValue.product = product;
            inValue.message = message;
            CreateUpdate.ProductServiceRef.UpdateProductResponse retVal = ((CreateUpdate.ProductServiceRef.IProduct)(this)).UpdateProduct(inValue);
            message = retVal.message;
            return retVal.UpdateProductResult;
        }
        
        public System.Threading.Tasks.Task<CreateUpdate.ProductServiceRef.UpdateProductResponse> UpdateProductAsync(CreateUpdate.ProductServiceRef.UpdateProductRequest request) {
